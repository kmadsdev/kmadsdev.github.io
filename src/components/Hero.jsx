        ...
        <section id="home" className="hero">
            <div className="hero-container">
                <div className="hero-content">
                    <p className="hero-greeting">👋 HELLO, MY NAME IS KAIQUE, ALSO KNOWN AS <span className="highlight">KMADS</span></p>
                    
                    <h1 className="hero-title">Kaique Souza</h1>
                    <p className="hero-subtitle">Software Engineer • Data Engineer</p>
